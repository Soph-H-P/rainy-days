export const productArray = [
  {
    ...
    tech: {
      ...
      description: `<p>Inspired by nature our unique waterproof fabric is both extremely water repellent and breathable. Like the lotus leaf, beads of water will simply run away from you.</p>
            `,
      image: "../../images/about-lotus-small.jpg",
    },
    weather: {
      icon: "../../images/windy-rain.svg",
      description: `
            <p>This jacket is what we like to call an all round jacket. Suitable for rain, wind and breathable enough that it is even comfortable while the sun is shining. </p>
            `,
    },
    reviews: [
      {
